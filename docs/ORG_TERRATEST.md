...
jobs:
  terratest:
    uses: Coalfire-CF/Actions/.github/workflows/ci-terratest.yml@e63fdc45774e5963925b931238797256692cf040 # v1.2.0
    with:
      test_mode: pr
      go_version: "1.26"
...
jobs:
  ...
  release-clean:
    needs: terratest
    uses: Coalfire-CF/Actions/.github/workflows/release-clean-archive.yml@e63fdc45774e5963925b931238797256692cf040 # v1.2.0
    with:
