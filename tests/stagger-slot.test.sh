...
# ---- drift guard: automation-dependabot-refresh.yml inlines this same algorithm (the generator
...
GEN="${REPO_ROOT}/.github/workflows/automation-dependabot-refresh.yml"
...
echo "OK: automation-dependabot-refresh.yml inline stagger algorithm matches the canonical script (drift-guarded)"
